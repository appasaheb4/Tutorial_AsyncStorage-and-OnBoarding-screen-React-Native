...
export default class VideoTab extends Component {
    ...
    */
    ...
    componentDidMount() {
        ...
        window.EventBus.on('pageClose', this.pageClose);
        window.EventBus.on('pageOpen', this.pageOpen);
    ...
    */
    ...
    renderBack() {
        ...
        return this.renderControl(
            <Image
                source={ require( '../tabs/videoimg/back.png' ) }
    ...
    renderVolume() {
        ...
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../tabs/videoimg/volume.png' ) } />
                </View>
            </View>
        );
    }
    ...
    renderFullscreen() {
        ...
        let source = this.state.isFullscreen === true ? require( '../tabs/videoimg/videoCompress.png' ) : require( '../tabs/videoimg/videoCompress.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderPlayPause() {  
        ...
        let source = this.state.paused === true ? require( '../tabs/videoimg/pause.png' ) : require( '../tabs/videoimg/play.png' );
        return this.renderControl(
            <Image source={ source } />,  
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../tabs/videoimg/loading.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
